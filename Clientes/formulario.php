        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="">Clientes</a>
                        ...
                        <div class="col-md-3">
                            ...
                            <form action="insertar.php" method="POST">
                                  ...
                                  <input type="text" class="form-control mb-3" name="Documento" placeholder="Documento">
                                    ...
                                    <input type="int" class="form-control mb-3" name="Celular" placeholder="Celular">
                                    <input type="int" class="form-control mb-3" name="Correo" placeholder="Correo">
