                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <form action="insertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="Id_factura" placeholder="Nombre">
                                    <input type="date" class="form-control mb-3" name="Fecha" placeholder="Descripcion">
                                    <input type="int" class="form-control mb-3" name="Valor" placeholder="Precio">
