        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="../Facturas/index.php">Facturas</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="Cerrar_sesion.php">Cerrar sesion</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 ">
                            ...
                            <form action="insertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="Nombre" placeholder="Nombre del insumo">
                            ...
                            <form action="../Facturas/insertar.php" method="POST">

                                  
                                    <input type="text" class="form-control mb-3" name="Id_factura" placeholder="Codigo de factura">
                                    <input type="date" class="form-control mb-3" name="fecha" step="2" value="<?php echo $row['fecha']  ?>">
                                    <input type="number" class="form-control mb-3" name="totalinsumo" value="<?php echo $totalinsumo ?>">                 
