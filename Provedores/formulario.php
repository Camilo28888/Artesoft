            ...
            <div id="page-content-wrapper">
                ...
                <div class="container mt-5">
                    <div class="row">
                            ...
                            <h2>Ingresar datos de proveedores</h2>
                            <form action="insertar.php" method="POST">
                                    ...
                                    <input type="int" class="form-control mb-3" name="Celular" placeholder="Celular" required>
                                    <input type="int" class="form-control mb-3" name="Correo" placeholder="Correo" required>
