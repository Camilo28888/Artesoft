                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <form action="insertar_usuario.php" method="POST">
                                    ...
                                    <input type="int" class="form-control mb-3" name="Contrasena" placeholder="Contrasena" required>
                                    <form action="index.php" method="POST" enctype="multipart/form-data"/>
                                     Añadir imagen: <input name="archivo" id="archivo" type="file"/>
                                    <input type="submit" name="subir" value="Subir imagen"/>
                                    </form>
                                    <input type="int" class="form-control mb-3" name="Telefono" placeholder="Telefono">
                                    ...
                                    <input type="date" class="form-control mb-3" name="Fecha_nac" step="2" value="<?php echo $row['Fecha_nac']  ?>">
